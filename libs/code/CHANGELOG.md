...
## [0.1.78](https://github.com/yermakoffivan/deepagents/compare/deepagents-code==0.1.77...deepagents-code==0.1.78) (2026-09-26)
...
* **code:** add `GPT-6 Astra` support ([#6141](https://github.com/yermakoffivan/deepagents/issues/6141)) ([048f989](https://github.com/yermakoffivan/deepagents/commit/048f9890bfe8b640e1e72085a4fa50d9084545f0))
...
* **code:** add durable Debug Console cost breakdown ([#6246](https://github.com/yermakoffivan/deepagents/issues/6246)) ([c981748](https://github.com/yermakoffivan/deepagents/commit/c9817483eeea620b1523dcfaed2802269c79d4fe))
...
* **code:** add thread picker ([#6197](https://github.com/yermakoffivan/deepagents/issues/6197)) ([9d3da12](https://github.com/yermakoffivan/deepagents/commit/9d3da1287ba5656d52ad7f2c75cf9062d46a4959))
...
* **code:** condense status bar cwd from the middle, tail intact ([#6252](https://github.com/yermakoffivan/deepagents/issues/6252)) ([f733893](https://github.com/yermakoffivan/deepagents/commit/f7338933e5ebd6959820023efb66704d6ab8ce7f))
...
* **code:** copy highlighted thread ID with `ctrl+c` ([#6431](https://github.com/yermakoffivan/deepagents/issues/6431)) ([0a6bd89](https://github.com/yermakoffivan/deepagents/commit/0a6bd899a0760af76bca025ea6af39997b78e611))
* **code:** copy model slug with Ctrl+click ([#6243](https://github.com/yermakoffivan/deepagents/issues/6243)) ([8a5c317](https://github.com/yermakoffivan/deepagents/commit/8a5c317e45edb0df4ad42ae79c1c5a6f8cff407f))
* **code:** default Auto classifier by provider ([#6039](https://github.com/yermakoffivan/deepagents/issues/6039)) ([99ed6c8](https://github.com/yermakoffivan/deepagents/commit/99ed6c83238851eb334e19b27d3faec8869fc9a7))
* **code:** default general-purpose subagents to fork mode ([#6024](https://github.com/yermakoffivan/deepagents/issues/6024)) ([d3ad134](https://github.com/yermakoffivan/deepagents/commit/d3ad134a49287d80b9897b0ef38b4635f8d7de94))
...
* **code:** label plugin servers in the MCP viewer ([#6539](https://github.com/yermakoffivan/deepagents/issues/6539)) ([d9defc1](https://github.com/yermakoffivan/deepagents/commit/d9defc124448fed2261b290e060c0cd532b0143a))
* **code:** limit thread resume age ([#6068](https://github.com/yermakoffivan/deepagents/issues/6068)) ([318311f](https://github.com/yermakoffivan/deepagents/commit/318311f56c3d3b9c4af4ece22fcfc387eeece5cc))
...
* **code:** list DeepSeek V4.1 Flash in picker ([#6254](https://github.com/yermakoffivan/deepagents/issues/6254)) ([0a93587](https://github.com/yermakoffivan/deepagents/commit/0a9358749d7654cc0bd9273a9e007be89abf316d))
...
* **code:** move MCP onto FastMCP and `langchain.mcp` ([#5922](https://github.com/yermakoffivan/deepagents/issues/5922)) ([0692ef1](https://github.com/yermakoffivan/deepagents/commit/0692ef1550568a585afe48705d54a4aa07002697))
...
* **code:** recommend GLM 5.3 models ([#6211](https://github.com/yermakoffivan/deepagents/issues/6211)) ([e7e88d5](https://github.com/yermakoffivan/deepagents/commit/e7e88d5efaf2bbce33237ea323fb68487eabd721))
* **code:** reuse server across workspace switches ([#6152](https://github.com/yermakoffivan/deepagents/issues/6152)) ([ca2d1ef](https://github.com/yermakoffivan/deepagents/commit/ca2d1ef7f270d0fa1040e5473f43e99937b5f03f))
* **code:** show `read_file` arguments when expanded ([#6392](https://github.com/yermakoffivan/deepagents/issues/6392)) ([902905f](https://github.com/yermakoffivan/deepagents/commit/902905f2508fe74dc0ba13d857f502e8ddbc807e))
* **code:** show cache timing in the footer ([#6394](https://github.com/yermakoffivan/deepagents/issues/6394)) ([f4c226b](https://github.com/yermakoffivan/deepagents/commit/f4c226b21cc07ee6cee6472ed726f86e69b8af36))
...
* **code:** show human invocations in usage teardown ([#6500](https://github.com/yermakoffivan/deepagents/issues/6500)) ([0779f31](https://github.com/yermakoffivan/deepagents/commit/0779f314841ec4216a189b70c615d06194731ecd))
* **code:** show session length in Debug Console ([#6224](https://github.com/yermakoffivan/deepagents/issues/6224)) ([05edbb1](https://github.com/yermakoffivan/deepagents/commit/05edbb14d0855303ce74d42a4bf368804856c43a))
...
* **code:** surface locally tracked GitHub stacks ([#6290](https://github.com/yermakoffivan/deepagents/issues/6290)) ([c08cae6](https://github.com/yermakoffivan/deepagents/commit/c08cae693e0036fcd45d979a7dfa3a7e306a0515))
...
* **code:** align file and console debug log formatting ([#6426](https://github.com/yermakoffivan/deepagents/issues/6426)) ([6c219d3](https://github.com/yermakoffivan/deepagents/commit/6c219d3a39a869b55c5ec434acf76f84217eb002))
* **code:** align prompt clipboard word deletion ([#6345](https://github.com/yermakoffivan/deepagents/issues/6345)) ([777d633](https://github.com/yermakoffivan/deepagents/commit/777d6336de3c7f1b6759a3f092fbfeddc4c54499))
* **code:** anchor editable refresh to its checkout ([#6455](https://github.com/yermakoffivan/deepagents/issues/6455)) ([a6d844d](https://github.com/yermakoffivan/deepagents/commit/a6d844d47126bb905f30e76569110cd68294a0b3))
...
* **code:** attribute dotenv config sources ([#6222](https://github.com/yermakoffivan/deepagents/issues/6222)) ([6f1ac85](https://github.com/yermakoffivan/deepagents/commit/6f1ac85c46604ef093a9d295fbcc52a8108aa8ed))
...
* **code:** bound transcript tail reconciliation ([#6057](https://github.com/yermakoffivan/deepagents/issues/6057)) ([8da3264](https://github.com/yermakoffivan/deepagents/commit/8da32644dc7dcad1125a840bc17ec3d5ea66b8c3))
...
* **code:** clarify compaction prompt ([#6429](https://github.com/yermakoffivan/deepagents/issues/6429)) ([15cf630](https://github.com/yermakoffivan/deepagents/commit/15cf6301e49e00963df876b6697fcc7c42d027d8))
* **code:** clarify thread message count header ([#6428](https://github.com/yermakoffivan/deepagents/issues/6428)) ([e775680](https://github.com/yermakoffivan/deepagents/commit/e775680e1cb5a52ba816e6c4663a647a7025d566))
* **code:** clarify unknown effort default ([#6337](https://github.com/yermakoffivan/deepagents/issues/6337)) ([5ee1073](https://github.com/yermakoffivan/deepagents/commit/5ee1073e9ab2fe9a286becb27ec7e694a4b3de4f))
* **code:** clean up new sandboxes when setup fails ([#6475](https://github.com/yermakoffivan/deepagents/issues/6475)) ([1ec8996](https://github.com/yermakoffivan/deepagents/commit/1ec8996c91fa6f68b3ec8145f279b8c1dea5dc20))
...
* **code:** confirm server restart for workspace switch ([#6178](https://github.com/yermakoffivan/deepagents/issues/6178)) ([7997203](https://github.com/yermakoffivan/deepagents/commit/7997203245915aa83e87db83252c04391bd00440))
* **code:** deduplicate footer picker clicks ([#6344](https://github.com/yermakoffivan/deepagents/issues/6344)) ([811e927](https://github.com/yermakoffivan/deepagents/commit/811e92738ffa491e991b9dea6573fff57a84d938))
* **code:** deduplicate mixed-ID model usage ([#6432](https://github.com/yermakoffivan/deepagents/issues/6432)) ([bdca132](https://github.com/yermakoffivan/deepagents/commit/bdca132ee7fbf84ab611392adb6846a1c545d26c))
...
* **code:** delay hook status in footer ([#6322](https://github.com/yermakoffivan/deepagents/issues/6322)) ([7f9e8ed](https://github.com/yermakoffivan/deepagents/commit/7f9e8ed3a555933902045792da9bb184950ee7b2))
* **code:** demote no-output hint suppression to debug ([#6245](https://github.com/yermakoffivan/deepagents/issues/6245)) ([d93ab33](https://github.com/yermakoffivan/deepagents/commit/d93ab3351bbf4c3687212f665094ccad100f2c08))
* **code:** diagnose workspace binding and runtime refusals ([#6384](https://github.com/yermakoffivan/deepagents/issues/6384)) ([f9ffd51](https://github.com/yermakoffivan/deepagents/commit/f9ffd51154296f81f832f5f184407bc0067acbaf))
...
* **code:** drop stale Anthropic thinking blocks ([#6300](https://github.com/yermakoffivan/deepagents/issues/6300)) ([fe01fac](https://github.com/yermakoffivan/deepagents/commit/fe01fac1fa3c4d30d9379a9e5f4273a622710049))
...
* **code:** expose unknown reasoning effort ([#6241](https://github.com/yermakoffivan/deepagents/issues/6241)) ([ed715ee](https://github.com/yermakoffivan/deepagents/commit/ed715eeba608af47c9ed7943822c25d935a30b9e))
...
* **code:** hide unavailable prompt search hints ([#6543](https://github.com/yermakoffivan/deepagents/issues/6543)) ([3ba4356](https://github.com/yermakoffivan/deepagents/commit/3ba435604c4b7f664978fa3c5f81914b05d86321))
...
* **code:** isolate LangSmith auth and workspace tracing ([#6061](https://github.com/yermakoffivan/deepagents/issues/6061)) ([794eda8](https://github.com/yermakoffivan/deepagents/commit/794eda83b777a2a7278e5726607e4b305801298d))
...
* **code:** isolate user shell tracing credentials ([#6242](https://github.com/yermakoffivan/deepagents/issues/6242)) ([35c21fa](https://github.com/yermakoffivan/deepagents/commit/35c21faafe329f4f6932c0941d163306e1aa06e5))
* **code:** keep absolute paths in normal input mode ([#6379](https://github.com/yermakoffivan/deepagents/issues/6379)) ([141ce98](https://github.com/yermakoffivan/deepagents/commit/141ce9851b876f733ef390ead3edbc509536a8e8))
* **code:** keep empty MCP servers searchable and match descriptions ([#6540](https://github.com/yermakoffivan/deepagents/issues/6540)) ([8d599c9](https://github.com/yermakoffivan/deepagents/commit/8d599c983e1b5e596d06b2569450dc2411ea8f3f))
* **code:** keep installation locks outside the uv tool directory ([#6472](https://github.com/yermakoffivan/deepagents/issues/6472)) ([ec128d1](https://github.com/yermakoffivan/deepagents/commit/ec128d14bd59561e955115c39b8d2a1cdd4dc720))
...
* **code:** keep prompt recall out of file picker ([#6494](https://github.com/yermakoffivan/deepagents/issues/6494)) ([86b7f85](https://github.com/yermakoffivan/deepagents/commit/86b7f85af7424ff2491206070897818d71e163cb))
* **code:** keep thread picker resume failures recoverable ([#6476](https://github.com/yermakoffivan/deepagents/issues/6476)) ([6a41c53](https://github.com/yermakoffivan/deepagents/commit/6a41c537fb1d4af7a34ef2340fff0f1c088548f4))
...
* **code:** make workspace configuration warnings actionable ([#6546](https://github.com/yermakoffivan/deepagents/issues/6546)) ([05900e7](https://github.com/yermakoffivan/deepagents/commit/05900e7ecc14ce64d9535617400a5e2f35d4c734))
...
* **code:** name models in classifier errors ([#6038](https://github.com/yermakoffivan/deepagents/issues/6038)) ([fff2c77](https://github.com/yermakoffivan/deepagents/commit/fff2c77c755c6d9dce3a6f776a9b94599ad05cfd))
* **code:** offload server config import ([#6089](https://github.com/yermakoffivan/deepagents/issues/6089)) ([90fe4f4](https://github.com/yermakoffivan/deepagents/commit/90fe4f4ac0a1311f1527b1a5cd02bd3ac8664580))
...
* **code:** open debug console at log bottom ([#6218](https://github.com/yermakoffivan/deepagents/issues/6218)) ([34f1b6b](https://github.com/yermakoffivan/deepagents/commit/34f1b6b037b24a1f2fe8b1d6112d9f8cdfe32bf2))
* **code:** order debug console log filters ([#6217](https://github.com/yermakoffivan/deepagents/issues/6217)) ([4bbad10](https://github.com/yermakoffivan/deepagents/commit/4bbad10385b22cb76dc40aaa4709d4726f20db02))
* **code:** parse extra skill dirs with platform separator ([#6151](https://github.com/yermakoffivan/deepagents/issues/6151)) ([56e4ef1](https://github.com/yermakoffivan/deepagents/commit/56e4ef1a5f447950a04ba37a7855c8e0babd2f11))
* **code:** pin resumed history to newest message ([#6225](https://github.com/yermakoffivan/deepagents/issues/6225)) ([9b5ca38](https://github.com/yermakoffivan/deepagents/commit/9b5ca384ff727f16c4f66a13308170cfba899b97))
...
* **code:** preserve `ask_user` consent receipts across user turns ([#6307](https://github.com/yermakoffivan/deepagents/issues/6307)) ([ca00490](https://github.com/yermakoffivan/deepagents/commit/ca004904d1e48385d805d6e3b7f62f82739cfc11))
...
* **code:** preview remote plugin contents before installation ([#6542](https://github.com/yermakoffivan/deepagents/issues/6542)) ([ec56c57](https://github.com/yermakoffivan/deepagents/commit/ec56c57fb086dc5bee06547f9896e49a52ead3b3))
* **code:** price Fireworks GLM-5.3 Flash usage ([#6223](https://github.com/yermakoffivan/deepagents/issues/6223)) ([d3627ea](https://github.com/yermakoffivan/deepagents/commit/d3627eaaeda2de62c19b0647ac29f80767057241))
* **code:** price Fireworks GLM-5.3 usage ([#6221](https://github.com/yermakoffivan/deepagents/issues/6221)) ([07c5d2e](https://github.com/yermakoffivan/deepagents/commit/07c5d2ecfe5db6238eff782f714fbbe08865e8d4))
* **code:** price nested usage with its own model and honor completions ([#6251](https://github.com/yermakoffivan/deepagents/issues/6251)) ([f413a40](https://github.com/yermakoffivan/deepagents/commit/f413a40f7e74ada749b18491aa276ee1224c7368))
...
* **code:** read `hooks.json` as UTF-8 in the legacy hook loader ([#6501](https://github.com/yermakoffivan/deepagents/issues/6501)) ([61bada8](https://github.com/yermakoffivan/deepagents/commit/61bada8bcbb62a40bfbe0345831228756f0ba353))
* **code:** reconcile interrupted tool requests ([#6321](https://github.com/yermakoffivan/deepagents/issues/6321)) ([376e988](https://github.com/yermakoffivan/deepagents/commit/376e988f98fea5e501050efe250d683259e551f5))
...
* **code:** refresh token and cost breakdown while open ([#6520](https://github.com/yermakoffivan/deepagents/issues/6520)) ([22524ed](https://github.com/yermakoffivan/deepagents/commit/22524edb7702d6fb31ffefd2d7d19549b17d2ed6))
* **code:** refuse a second sandbox workspace ([#5979](https://github.com/yermakoffivan/deepagents/issues/5979)) ([cb4c973](https://github.com/yermakoffivan/deepagents/commit/cb4c973172f7838eefa328ea0c6ca334b6aaab98))
...
* **code:** remove contradictory and invalid system-prompt instructions ([#6072](https://github.com/yermakoffivan/deepagents/issues/6072)) ([2776a66](https://github.com/yermakoffivan/deepagents/commit/2776a66a955976e4fffbf4cd8612828012feaebc))
...
* **code:** replace composer with prompt search and prevent query feedback ([#6346](https://github.com/yermakoffivan/deepagents/issues/6346)) ([a52ecea](https://github.com/yermakoffivan/deepagents/commit/a52ecea1f4b159a5ec0c667c6d05e26ea701db30))
* **code:** report a mis-encoded `config.toml` from the older config writers ([#6514](https://github.com/yermakoffivan/deepagents/issues/6514)) ([a6e2140](https://github.com/yermakoffivan/deepagents/commit/a6e21408ccc1b9a80f941d3458a0ae58dcc29abe))
...
* **code:** resolve plugin MCP servers for login ([#6524](https://github.com/yermakoffivan/deepagents/issues/6524)) ([ae00358](https://github.com/yermakoffivan/deepagents/commit/ae00358ed85fb2207cb3ef260d5181a601b5b585))
* **code:** resolve project policy per workspace ([#6064](https://github.com/yermakoffivan/deepagents/issues/6064)) ([ea1f253](https://github.com/yermakoffivan/deepagents/commit/ea1f2536537efb01c71dce54c46894b9318c4f80))
...
* **code:** restrict auto classifier IDs to the review batch enum ([#6250](https://github.com/yermakoffivan/deepagents/issues/6250)) ([6152733](https://github.com/yermakoffivan/deepagents/commit/6152733cbd6b73709a704f3f41b93e2576c5cd52))
* **code:** retry bare `openai.APIError` raised mid-stream ([#6499](https://github.com/yermakoffivan/deepagents/issues/6499)) ([0f95915](https://github.com/yermakoffivan/deepagents/commit/0f959156b828f9deb08438b71dbc9a65c13b1714))
...
* **code:** run sandbox creation and entry off the guarded event loop ([#6017](https://github.com/yermakoffivan/deepagents/issues/6017)) ([fd28bfb](https://github.com/yermakoffivan/deepagents/commit/fd28bfb5c5e1ca18af975d8e57d361c1c23f81b7))
...
* **code:** scope project dotenv to workspaces ([#5980](https://github.com/yermakoffivan/deepagents/issues/5980)) ([678c115](https://github.com/yermakoffivan/deepagents/commit/678c11559d7534ee5e16ceebfacf01eeb6536ac7))
* **code:** scroll overflowing chat input pastes ([#6382](https://github.com/yermakoffivan/deepagents/issues/6382)) ([b522fd4](https://github.com/yermakoffivan/deepagents/commit/b522fd4a74b2349b25f3f1f630265f7e456430ee))
* **code:** separate access-policy compatibility from runtime identity ([#6386](https://github.com/yermakoffivan/deepagents/issues/6386)) ([95c7630](https://github.com/yermakoffivan/deepagents/commit/95c763059fdec12991232fc63418755ba568af74))
* **code:** serialize transcript tail reconciliation ([#6143](https://github.com/yermakoffivan/deepagents/issues/6143)) ([5fb8b69](https://github.com/yermakoffivan/deepagents/commit/5fb8b699843ecf93debc592d9dbb8a534f54db09))
* **code:** show and handle escape during MCP browser login ([#6541](https://github.com/yermakoffivan/deepagents/issues/6541)) ([0a1967e](https://github.com/yermakoffivan/deepagents/commit/0a1967e94c4bce9cb4a28b8368510f3392e9e52b))
...
* **code:** show loading labels for thread details ([#6430](https://github.com/yermakoffivan/deepagents/issues/6430)) ([5c09b92](https://github.com/yermakoffivan/deepagents/commit/5c09b9291924df7f67fbc73fda2214a0a50005ea))
* **code:** show session cost warnings in a modal ([#6393](https://github.com/yermakoffivan/deepagents/issues/6393)) ([c1395da](https://github.com/yermakoffivan/deepagents/commit/c1395dab009690a30d495bfcae33fb92f62d08c4))
* **code:** show the spinner during pre-stream turn setup ([#6253](https://github.com/yermakoffivan/deepagents/issues/6253)) ([fa609c2](https://github.com/yermakoffivan/deepagents/commit/fa609c23ba883557d015529d431ae266847e388c))
* **code:** silence absent themes config warning ([#6220](https://github.com/yermakoffivan/deepagents/issues/6220)) ([b93f748](https://github.com/yermakoffivan/deepagents/commit/b93f7483bb5722bbae281a19a80a7aea21d38832))
* **code:** silence non-media path decoder traces ([#6427](https://github.com/yermakoffivan/deepagents/issues/6427)) ([3693e9d](https://github.com/yermakoffivan/deepagents/commit/3693e9d01a94a4e881cbb5f92438adfec27cd77e))
...
* **code:** standardize recent-thread environment variable ([#6205](https://github.com/yermakoffivan/deepagents/issues/6205)) ([a4c218e](https://github.com/yermakoffivan/deepagents/commit/a4c218e185bc49a11a381c3afde91f6efa7226fc))
* **code:** suppress historical cost warnings on resume ([#6471](https://github.com/yermakoffivan/deepagents/issues/6471)) ([13170ea](https://github.com/yermakoffivan/deepagents/commit/13170ea5b07206c94d535141af7e311666f17b7b))
* **code:** surface stale updates in-session ([#6063](https://github.com/yermakoffivan/deepagents/issues/6063)) ([cdb9d4c](https://github.com/yermakoffivan/deepagents/commit/cdb9d4c30f4419c0eb2c98ad53940875e4dfbe9e))
* **code:** surface the LangSmith credential in `dcode config` ([#6083](https://github.com/yermakoffivan/deepagents/issues/6083)) ([a1a0887](https://github.com/yermakoffivan/deepagents/commit/a1a0887f7e42d0f8515ad415c9b9062e89350e8c))
...
* **code:** treat effort changes as cache identity for OpenAI and Anthropic ([#6196](https://github.com/yermakoffivan/deepagents/issues/6196)) ([cacd50a](https://github.com/yermakoffivan/deepagents/commit/cacd50adc365e949e4f0b9a7e94ad6f8eeb7d497))
...
* **code:** use UTF-8 for prompts and skill files ([#6474](https://github.com/yermakoffivan/deepagents/issues/6474)) ([8feaa0f](https://github.com/yermakoffivan/deepagents/commit/8feaa0fcce7ee967b1411c247d6f4eab202aa66d))
...
* **code:** warm lazy MCP caches off the event loop ([#6517](https://github.com/yermakoffivan/deepagents/issues/6517)) ([e6419a6](https://github.com/yermakoffivan/deepagents/commit/e6419a6fbabf18d8232fb6b0a0283bc933b4bae3))
* **code:** wrap debug logs before the scrollbar ([#6219](https://github.com/yermakoffivan/deepagents/issues/6219)) ([ca7999a](https://github.com/yermakoffivan/deepagents/commit/ca7999a8a9984e110a3b80d2e5f71dbe895f58ec))


### Performance Improvements

* **code,quickjs:** omit middleware trace inputs ([#6015](https://github.com/yermakoffivan/deepagents/issues/6015)) ([673844d](https://github.com/yermakoffivan/deepagents/commit/673844d06fe0ee186f2e492c3c0a19ec5facffc2))
* **code:** log thread loading phase timings ([#6490](https://github.com/yermakoffivan/deepagents/issues/6490)) ([ad038f8](https://github.com/yermakoffivan/deepagents/commit/ad038f87e07e13791ff9b1e239326d2c959fd412))
...
* **code:** rank checkpoint row IDs before loading blobs ([#6488](https://github.com/yermakoffivan/deepagents/issues/6488)) ([933eaea](https://github.com/yermakoffivan/deepagents/commit/933eaeaddea12d1d6fcd0a8cd7716e948ff1df58))
* **code:** rank message row IDs before loading prompts ([#6489](https://github.com/yermakoffivan/deepagents/issues/6489)) ([17ea378](https://github.com/yermakoffivan/deepagents/commit/17ea378fcb04f15c916e64eaf24a833b3a63c504))
* **code:** reuse Auto classifier history ([#6056](https://github.com/yermakoffivan/deepagents/issues/6056)) ([44926fa](https://github.com/yermakoffivan/deepagents/commit/44926fa8f26dfb24d9a0e3ded335c48b123d193d))
* **code:** skip transcript scan on prompt submit ([#6402](https://github.com/yermakoffivan/deepagents/issues/6402)) ([443d34b](https://github.com/yermakoffivan/deepagents/commit/443d34bfde4f22cbc7f9ac71be766922a041e08c))
