...
## [0.7.12](https://github.com/yermakoffivan/deepagents/compare/deepagents==0.7.11...deepagents==0.7.12) (2026-08-31)
...
* **sdk:** expose `execute` exit code in artifact ([#5300](https://github.com/yermakoffivan/deepagents/issues/5300)) ([de8bfca](https://github.com/yermakoffivan/deepagents/commit/de8bfca8255d673c1e7860e8c158ed119238197e))
...
* **sdk:** identify file-capable provider classes ([#5326](https://github.com/yermakoffivan/deepagents/issues/5326)) ([e5d5391](https://github.com/yermakoffivan/deepagents/commit/e5d53917c01aadcebe4e7e4a1974322033ae6c87))
...
* **sdk:** resolve exact-file `delete` targets with first-match-wins o… ([#5229](https://github.com/yermakoffivan/deepagents/issues/5229)) ([6dd2a7d](https://github.com/yermakoffivan/deepagents/commit/6dd2a7d2f83bd63844a987f6ec65ac9244ec8c5b))
* **sdk:** scrub multimodal content blocks unsupported by the model's profile ([#5194](https://github.com/yermakoffivan/deepagents/issues/5194)) ([bdc6104](https://github.com/yermakoffivan/deepagents/commit/bdc610445534ba339360f3988de6b50b60482f1d))
